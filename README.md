...
* East is the strongest region by a wide margin: ₹7,36,080 in revenue (41% of total) from 173 orders — more than double the next-best region.
...
* Printers are the single biggest revenue driver: ₹9,34,500 (52% of total revenue) from just 73 orders — high price point (avg ₹2,100) more than makes up for lower order volume.
...
* Q3 2021 (Jul–Sep) was the strongest quarter at ₹5,10,170; Q2 2021 was the weakest full quarter at ₹3,82,220.
* February and September were the two strongest individual months — both crossing ₹2,20,000 — useful for spotting recurring seasonal demand.


## 💡 Business recommendations


* Investigate why North and South underperform on Printers specifically — replicating East/West's Printer strategy there could be the single highest-leverage fix.
* Siddhu's multi-region success is worth studying as a playbook for the other salespeople, who are currently region-locked.
* Low-value, high-frequency items (Mouse, Keyboard) could be bundled with high-margin items (Printers, Monitors) to lift average order value.
